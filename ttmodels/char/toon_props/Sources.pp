...
#define most_maya_files \
   av_screen.mb geyser.mb partyBall.mb traintrack2.mb wedding_cake.mb ladder2.mb singing.mb train.mb ship.mb
...
#begin optchar_egg
  ...
  #define OPTCHAR_OPTS \
     ...
     -p joint_poleRT,root \
     -p joint_thereel,joint_poleROT \
     -p fishing_pole1,joint_poleROT \
     -p joint_pole1,fishing_pole1 \
     -p joint_pole2,joint_pole1 \
     -p joint_pole3,joint_pole2 \
     -p joint_pole4,joint_pole3 \
     -p joint_pole5,joint_pole4 \
     -p joint_pole6,joint_pole5 \
     -p ring4,joint_pole6 \
     -p joint_attachBill,ring4 \
     -p ring3,joint_pole4 \
     -p joint_toString4,ring3 \
     -p ring2,joint_pole3 \
     -p joint_toString3,ring2 \
     -p ring1,joint_pole2 \
     -p joint_toString2,ring1 \
     -p joint_toString1,joint_pole1
#end optchar_egg
...
#begin optchar_egg
  #define TARGET_DIR optchar
  #define SOURCES \
    squirting-flower.egg
  #define OPTCHAR_OPTS \
     $[OPTCHAR_OPTS] \
     -expose joint_attachSpray
#end optchar_egg
...
#begin optchar_egg
  ...
  #define OPTCHAR_OPTS \
     $[OPTCHAR_OPTS] \
     -expose joint_toSpray
#end optchar_egg

#begin optchar_egg
  #define TARGET_DIR optchar
  #define SOURCES \
    hypnotize-mod.egg hypnotize-chan.egg
#end optchar_egg

#begin optchar_egg
  #define TARGET_DIR optchar
  #define SOURCES \
    tnt-mod.egg tnt-chan.egg
  #define OPTCHAR_OPTS \
     $[OPTCHAR_OPTS] \
     -expose joint_attachEmitter
#end optchar_egg

//
// TRANSFORM - for the skeleton-less ones
//
...
#begin filter_egg
  #define TARGET_DIR optchar
  #define SOURCES \
    marbles-mod.egg marbles-chan.egg
  #defer COMMAND \
     egg-trans -TR 0,180,0 -TS 0.25 \
     -o $[target] $[source]
#end filter_egg
...
// The bottle is used in the tutorial
#begin install_egg
...
// Finally, install everything that should be installed.
// Anvil is used in catching game
#begin install_egg
  #define SOURCE_DIR optchar
  #define SOURCES \
...
#begin install_egg
  #define SOURCE_DIR optchar
  #define SOURCES \
    sandbag-mod.egg weight-mod.egg safe-mod.egg piano-mod.egg \
    1dollar-bill-mod.egg fruit-pie-slice.egg \
    birthday-cake-mod.egg feather-mod.egg magnet.egg rake-mod.egg \
    flowerpot-mod.egg megaphone.egg trapdoor.egg \
    banana-peel-mod.egg cubes-mod.egg \
    cane.egg hat.egg lips.egg lipstick.egg firehose-mod.egg \
    glass-mod.egg battle_hydrant.egg hypnotize-mod.egg tnt-mod.egg \
...
//    bikehorn-mod.egg aoogah-mod.egg 
  #define UNPAL_SOURCES \
    ...
    flowerpot-chan.egg banana-peel-chan.egg birthday-cake-chan.egg \
...
// Install fanfare model (just a partyball)
#begin install_egg
  #define SOURCES \
    partyBall.egg
  #define PHASE 5
...
// Install sound gag models
#begin install_egg
  #define SOURCES \
    aoogah.egg bikehorn.egg bugle.egg elephant.egg fog_horn.egg whistle.egg
  #define PHASE 5
#end install_egg

// Install uber gag models
#begin install_egg
  #define SOURCES \
    av_screen.egg geyser.egg traintrack2.egg wedding_cake.egg ladder2.egg singing.egg train.egg ship.egg
  #define PHASE 5
#end install_egg
